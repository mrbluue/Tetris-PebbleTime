...
#define GAME_SCORES_VERSION  2

#define GAME_SAVE_VERSION_KEY    737
#define GAME_STATE_KEY           737415    // TETRIS
#define GAME_GRID_BLOCK_KEY      737415810 // TETRISBLO
#define GAME_GRID_COLOR_KEY      737415601 // TETRISCOL

#define GAME_CONTINUE_KEY        7374150   // TETRIS0

#define GAME_SETTINGS_KEY        737415537 // TETRISSET

#define GAME_SCORES_KEY          737415560 // TETRISSCO
#define GAME_SCORES_NAME_KEY     737415561 // TETRISSC1
#define GAME_SCORES_VERSION_KEY  737415562 // TETRISSC2
